...
requirements = ['Click>=6.0', 'websockets', 'aiohttp<4.0.0', 'syslog_rfc5424_formatter', 'pytest', 'pytest-aiohttp',
                'requests', 'itsdangerous', 'faraday-plugins', 'python-owasp-zap-v2.4']
